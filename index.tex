...
understanding how uncertainty propagates through an analysis. However,
these decisions are rarely studied because tracing every alternatives
considered by authors is often impractical, and reworking on a completed
analysis is generally of limited interest. Consequently, researchers
must manually review large bodies of published analyses in the
literature to understand how such choices are made and to identify
common choices within a field. In this work, we propose a workflow to
automatically extract analytic decisions and their stated reasons from
published literature using Large Language Models (Claude and Gemini).
Our method also introduces a paper similarity measure based on decision
similarity and visualizes papers using clustering algorithms. We apply
this workflow to a set of studies on the effect of particulate matter on
mortality conducted by researchers worldwide. This approach enables
large-scale, automated studies of decision-making practices in data
analysis, providing an alternative to existing manual interview-based
studies and small-scale `many analysts experiments'.    
\end{abstract}
