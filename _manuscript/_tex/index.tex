...
\item
  Our task differs from conventional text extraction using large
  language models (LLM) in that \st{it requires higher-order reasoning
  to identify the decisions made by the authors}.
\end{itemize}
