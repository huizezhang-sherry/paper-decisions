...
To record these decisions in a data structure, the tidy data principle
\citet{wickham2014} provides the guidance on how to structure the data
where each variable should be in a column, each observation in a row. In
the context of decisions made during data analysis, we adapt this
principle to mean that each row represents a decision made by the
authors of a paper and a paper often spans multiple decisions.
