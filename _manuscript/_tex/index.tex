...
The results follows examines 8 papers for modelling the effect of
...
8 papers, we extracted 292 decisions (\textasciitilde{} 5 decisions each
paper). Out of which the most are parameter-related decisions and
temporal decision, accounting for 52\% and 46\%, respectively.
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.7315}}@{}}
...
smoothing spline & humidity & 2, 3, 4, 5, 6, 8, 50\% of the data \\
smoothing spline & temperature & 2, 3, 4, 5, 6, 8, 50\% of the data \\
smoothing spline & time & 3, 4, 5, 6, 7, 7.7, 8, 9, 10, 12, 30, 100, 5\%
of the data in each neighborhood \\

\end{longtable}

Figure~\ref{fig-cluster-paper} shows the clustering of the 62 papers
