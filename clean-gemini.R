...
gemini_df <- gemini_df |>
  bind_rows(tibble(paper = "chen2008influence", id = 13, model = "general linear model", variable = "temperature",
                   method = NA, parameter = NA, type = "temperal", reason = NA, decision = "first 3 days"),
            ...
            tibble(paper = "ko2007effects", id = 17, model = "generalized additive model", variable = "PM",
                   method = NA, parameter = NA, type = "temperal", reason = NA, decision = "cumulative lags by 2 (lag 0 and 1)"),
            tibble(paper = "ko2007effects", id = 18, model = "generalized additive model", variable = "PM",
                   method = NA, parameter = NA, type = "temperal", reason = NA, decision = "cumulative lags by 3 (lag 0 and 2)"),
            tibble(paper = "ko2007effects", id = 19, model = "generalized additive model", variable = "PM",
                   method = NA, parameter = NA, type = "temperal", reason = NA, decision = "cumulative lags by 4 (lag 0 and 3)"),
            tibble(paper = "ko2007effects", id = 20, model = "generalized additive model", variable = "PM",
                   method = NA, parameter = NA, type = "temperal", reason = NA, decision = "cumulative lags by 5 (lag 0 and 4)"),
            tibble(paper = "ko2007effects", id = 21, model = "generalized additive model", variable = "PM",
                   method = NA, parameter = NA, type = "temperal", reason = NA, decision = "cumulative lags by 6 (lag 0 and 5)"),
            tibble(paper = "lopez2010air", id = 16, model = "Poisson regression model", variable = "temperature",
                   method = NA, parameter = NA, type = "temperal", reason = NA, decision = "lags 2 to 4 averages"),
